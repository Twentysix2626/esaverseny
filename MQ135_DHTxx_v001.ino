...
//DHT11: G->ground
//       V,N->5V a V es N ossze vannak kombinalva a mi szenzorunkon
//       D-> 2 (digital)

//MUKODES: egy ideig bemelegedik aztan pontos a merese
//de hogyan kene rendesen kalibralni? honnnan tudjuk mennyire pontos?
